export default function App() {
  return (
    <div>
      <nav className="bg-red-400 text-white flex p-4 justify-between border-t-4 border-blue-800">
        <div className="flex">
        ...
        <div>
          <button className="border border-solid border-white rounded py-1 px-3 hover:bg-red-500	">
            Login
          </button>
        </div>
      </nav>
      ...
      <div className="mt-5 ml-24">
        <button className="bg-blue-500 text-white font-semibold rounded px-2 py-1 hover:bg-blue-400 ">
          Button One
        </button>
      </div>

      <div
        className="bg-red-100	 border border-red-400 text-red-700 px-4 py-3 rounded my-5 w-10/12 mx-auto"
        role="alert"
      >
